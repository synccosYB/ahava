...
const APPROVALS_TEMPLATES: PolicyTemplate[] = [
  ...
  },
  {
    ...
    description: "Short requests (≤ 16 hours) auto-approve. Longer requests still need manager sign-off with quick escalation.",
    suggestedName: "Auto-Approve Short Requests",
    suggestedDescription: "Auto-approves PTO requests of 16 hours or shorter; longer requests follow the standard chain.",
    rules: {
      requireManagerApproval: true,
      autoApproveThreshold: 16,
      escalationHours: 24,
      requireCommentOnDenial: true,
      notifyOnSubmission: true,
      notifyOnDecision: true,
    ...
    summary: [
      { label: "Auto-approve", value: "≤ 16 hr" },
  ...
  },
  {
    ...
    description: "Auto-approves up to a week of hours, longer escalation window, and lighter notification footprint.",
    suggestedName: "Hands-Off Approvals",
    suggestedDescription: "Lightweight approval workflow that auto-approves up to a week (56 hours) of PTO.",
    rules: {
      requireManagerApproval: false,
      autoApproveThreshold: 56,
      escalationHours: 72,
    ...
    summary: [
      { label: "Auto-approve", value: "≤ 56 hr" },
