...
const PERMISSION_KEYS = [
  ...
  { key: "attendance.delete", name: "Delete Attendance", description: "Delete punch records directly", module: "attendance" },
  ...
  { key: "reconciliation.run", name: "Run Reconciliation", description: "Recompute and reconcile attendance hours, PTO balances, and verify payroll exports against the central engine", module: "reports" },
...
const SYSTEM_ROLES = [
  ...
  },
  {
    ...
    permissions: [
      ...
      "attendance.view_all", "attendance.edit", "attendance.delete", "attendance.manage_rules", "attendance.approve_corrections",
      ...
      "reports.view", "reports.export", "reconciliation.run",
      "kiosk.manage",
  ...
  },
  {
    ...
    permissions: [
      ...
      "users.view",
      "departments.view", "departments.edit",
      "attendance.view_team", "attendance.edit", "attendance.delete", "attendance.approve_corrections",
