import { db } from "./db";
import { users, departments, permissions, roles, rolePermissions, policyTypes, userRoles } from "@shared/schema";
import { eq } from "drizzle-orm";
import bcrypt from "bcryptjs";

const PERMISSION_KEYS = [
  { key: "system.super_admin", description: "Full system access", module: "system" },
  { key: "company.manage", description: "Manage company settings", module: "company" },
  { key: "company.view", description: "View company information", module: "company" },
  { key: "users.create", description: "Create users", module: "users" },
  { key: "users.view", description: "View users", module: "users" },
  { key: "users.edit", description: "Edit user details", module: "users" },
  { key: "users.deactivate", description: "Deactivate users", module: "users" },
  { key: "roles.manage", description: "Manage roles and permissions", module: "roles" },
  { key: "departments.create", description: "Create departments", module: "departments" },
  { key: "departments.view", description: "View departments", module: "departments" },
  { key: "departments.edit", description: "Edit departments", module: "departments" },
  { key: "departments.delete", description: "Delete departments", module: "departments" },
  { key: "attendance.view_self", description: "View own attendance", module: "attendance" },
  { key: "attendance.view_team", description: "View team attendance", module: "attendance" },
  { key: "attendance.view_all", description: "View all attendance", module: "attendance" },
  { key: "attendance.clock", description: "Clock in/out", module: "attendance" },
  { key: "attendance.edit", description: "Edit attendance records", module: "attendance" },
  { key: "attendance.manage_rules", description: "Manage attendance rules and policies", module: "attendance" },
  { key: "attendance.approve_corrections", description: "Approve attendance corrections", module: "attendance" },
  { key: "pto.request", description: "Submit PTO/time-off requests", module: "pto" },
  { key: "pto.view_self", description: "View own PTO/time-off", module: "pto" },
  { key: "pto.view_team", description: "View team PTO/time-off", module: "pto" },
  { key: "pto.view_all", description: "View all PTO/time-off", module: "pto" },
  { key: "pto.approve", description: "Approve/deny PTO/time-off requests", module: "pto" },
  { key: "pto.manage_policies", description: "Manage PTO policies and balances", module: "pto" },
  { key: "payroll.view_self", description: "View own payroll", module: "payroll" },
  { key: "payroll.view_all", description: "View all payroll", module: "payroll" },
  { key: "payroll.view_batches", description: "View payroll batches", module: "payroll" },
  { key: "payroll.manage", description: "Manage payroll runs", module: "payroll" },
  { key: "payroll.mark_sent", description: "Mark payroll as sent", module: "payroll" },
  { key: "payroll.export", description: "Export payroll data", module: "payroll" },
  { key: "reports.view", description: "View reports", module: "reports" },
  { key: "reports.export", description: "Export reports", module: "reports" },
  { key: "kiosk.manage", description: "Manage kiosk devices", module: "kiosk" },
  { key: "kiosk.use", description: "Use kiosk for clock-in", module: "kiosk" },
  { key: "locations.manage", description: "Manage locations", module: "locations" },
  { key: "locations.view", description: "View locations", module: "locations" },
  { key: "approvals.view", description: "View pending approvals", module: "approvals" },
  { key: "approvals.manage", description: "Manage approval workflows", module: "approvals" },
  { key: "alerts.view", description: "View alerts and notifications", module: "alerts" },
  { key: "alerts.manage", description: "Manage alert configurations", module: "alerts" },
